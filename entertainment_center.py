...
fight_club = media.Movie("Fight Club",
                         "Ed Norton confronts an existential crisis with a bare knuckle fighting ring",
...
tron_legacy = media.Movie("Tron: Legacy",
                          "Some guy finds his dad in an alternative digital universe",
                          "http://t1.gstatic.com/images?q=tbn:ANd9GcSchLICLsn0n_GlVBYmaIZjwcYDuqvb1fg4nVvr8WAh3FN8EqfY",
                          "https://youtu.be/L9szn1QQfas")

zombie_land = media.Movie("Zombie Land",
                          "Woody Harrilson kills lots of zombies with that kid from social network, and some other people",
                          "http://www.gstatic.com/tv/thumb/movieposters/3532040/p3532040_p_v8_ae.jpg",
                          "http://www.youtube.com/watch?v=pYVQgsYb9gY")

war_games = media.Movie("War Games",
                        "Some hacker kid saves the world by playing tic-tac-toe",
                        "http://t2.gstatic.com/images?q=tbn:ANd9GcTsqaGEcvep6oEDEPWXHihceN4VWNH7n9O9gKMaDyTJeWFdlN3r",
